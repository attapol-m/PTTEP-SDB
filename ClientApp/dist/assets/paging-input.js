  ...
  (function ($) {
    ...
    $.fn.dataTableExt.oPagination.input = {
      'fnInit': function (oSettings, nPaging, fnCallbackDraw) {
        ...
        var nFirstPipe = document.createElement('span');
        var nPrevious = document.createElement('span');
        var nPreviousPipe = document.createElement('span');
        var nNext = document.createElement('span');
        var nNextPipe = document.createElement('span');
        var nLastPipe = document.createElement('span');
        ...
        nFirstPipe.innerHTML = "|";
        nPrevious.innerHTML = language.sPrevious;
        nPreviousPipe.innerHTML = "|"
        nNext.innerHTML = language.sNext;
        nNextPipe.innerHTML = "|"
        nLast.innerHTML = language.sLast;
        nLastPipe.innerHTML = "|"

        nFirst.className = firstClassName + ' ' + classes.sPageButton + ' btn-default';
        nPrevious.className = previousClassName + ' ' + classes.sPageButton + ' btn-default';
        nNext.className = nextClassName + ' ' + classes.sPageButton + ' btn-default';
        nLast.className = lastClassName + ' ' + classes.sPageButton + ' btn-default';

        nOf.className = paginateOfClassName;
        nPage.className = paginatePageClassName;
        nInput.className = 'form-control ' + paginateInputClassName;
        ...
        nPaging.appendChild(nFirstPipe);
        nPaging.appendChild(nPrevious);
        nPaging.appendChild(nPreviousPipe);
        nPaging.appendChild(nPage);
        nPaging.appendChild(nInput);
        nPaging.appendChild(nOf);
        nPaging.appendChild(nNextPipe);
        nPaging.appendChild(nNext);
        nPaging.appendChild(nLastPipe);
      ...
      'fnUpdate': function (oSettings) {
        ...
        $(an).children('.' + paginateOfClassName).html(' from ' + iPages);
